...
namespace HideMe
{
    ...
    public class HideMePlugin : BaseUnityPlugin
    {
        ...
        public static readonly ManualLogSource HideMeLogger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                HideMeLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                HideMeLogger.LogError($"There was an issue loading your {ConfigFileName}");
                HideMeLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
